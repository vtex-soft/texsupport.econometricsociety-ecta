...
-   `ecta-template.tex` - the main template file should be used for article preparation;
-   `ecta-sample.pdf` - sample file and instructions for the preparation of a
...
-   `ecta-sample_final.pdf` - sample file with `final` option for prepublication;
-   `ecta-sample.tex` - source file for the instructions paper `ecta-sample.pdf`;
-   `figure1.eps`, `figure1.pdf` - sample figures for `ecta-sample.pdf`.
...
-   Read the instructions (`ecta-sample.pdf`) for the preparation of your LaTeX document;
-   Use the template file `ecta-template.tex` to prepare your manuscript.
